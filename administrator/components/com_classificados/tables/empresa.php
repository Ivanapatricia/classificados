 ...
 * @since  1.0.0
 */
class ClassificadosTableEmpresa extends Table
{
	/**
	 * Constructor
	 *
	...
	{
		//JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'ClassificadosTableEmpresa', array('typeAlias' => 'com_classificados.empresa'));
		parent::__construct('#__classificados_items', 'id', $db);
		//JTableObserverTags::createObserver($this, array('typeAlias' => 'com_classificados.empresa'));
	}
	...
	{
		$k = $this->_tbl_key;
		return 'com_classificados.empresa.'.(int) $this->$k;
	}*/
	/**
	...
	/*protected function _getAssetParentId(JTable $table = NULL, $id = NULL)
	{
		...
		if (($this->catid)&& !empty($this->catid))
		{
			...
			$assetParent->loadByName('com_classificados.category.' . (int) $this->catid);
		}
		else
		{
			// The item has the component as asset-parent
			$assetParent->loadByName('com_classificados');
		}
